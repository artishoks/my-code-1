...
def start_game():
    ...
    while True:
        ...
        if leaf.distance(caterpillar2) < 20:
            place_leaf()
            caterpillar2_lenght = caterpillar_lenght + 1
            caterpillar2.shapesize(1, caterpillar_lenght, 1)
            caterpillar2_speed = caterpillar_speed + 1
            score2 = score2 + 10
            display_score(score, score2)
...
def game_over():
    ...
    t.penup()
    t.hideturtle()
    t.write('Конец игры!', align='center', font=('Artial', 30, 'normal'))
